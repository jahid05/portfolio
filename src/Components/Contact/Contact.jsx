...
const Contact = () => {
  return (
    <div className="bg-theme-300 min-h-screen px-8">
      ...
      <div className="container mx-auto md:px-52 py-4 md:py-8 grid md:grid-cols-2 gap-y-12 md:gap-y-0">
        <div
        ...
        >
          ...
          <form className="relative">
            ...
            <div className="absolute right-0 py-2">
              <button className="rounded-full hover:text-theme-300 group relative flex items-center btn md:text-lg text-md font-semibold px-8 py-2 border-2 border-theme-100 text-theme-100">
